 ...
 * Dictionary Match
 *
 * Detect common passwords, english words, last names, etc.,
 * using a static dictionary.
 *
...
class DictionaryMatch extends Match
{
    ...
    protected function uppercaseEntropy()
    {
        ...
        // 1 extra bit of entropy. allcaps and end-capitalized are common
        // enough to underestimate as 1 extra bit to be safe.
        ...
        // uppercase+lowercase letters with U uppercase letters or less.
        // Or, if there's more uppercase than lower (for e.g. PASSwORD),
