...
abstract class Match implements MatchInterface
{
    ...
    /**
     * Position at which the matching $token begins in the $password.
     *
     *@var integer
     */
    public $begin;
    ...
    /**
     * Position at which the matching $token ends in the $password.
     *
     * @var integer
     */
    public $end;
    ...
    /**
     * Pattern being used for matching.
     *
     * @var string
     */
    public $pattern;
    ...
    /**
      ...
      *
      * @return array Array of capture groups. Captures in a group have named indexes: 'begin', 'end', 'token'.
      *     e.g. fishfish /(fish)/
      *     array(
      *       array(
